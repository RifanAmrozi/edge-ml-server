...
#         self.hands = None
#         print("⚠️ MediaPipe disabled for headless deployment")
...
#         """Simplified hand movement detection without MediaPipe"""
#         return {
#             'left_hand': None,
#             'right_hand': None,
#             'hand_count': 0,
...
#         """More sensitive pose analysis for suspicious actions"""
...
#                                       left_shoulder, right_shoulder, action_scores, pose_analysis):
#         """More sensitive pocket reaching detection"""
...
#         """More sensitive bag concealment detection"""
...
#         """More sensitive head movement analysis"""
...
#         """More sensitive body language analysis"""
...
#         """More sensitive rapid movement detection"""
...
#         min_thresholds = {
#         'reaching_to_pocket': 5.0,    
#         'hiding_in_bag': 8.0,        
#         'concealing_object': 3.0,    
#         'looking_around': 4.0,       
#         'rapid_movements': 6.0,      
#         'hand_near_products': 4.0,   
#         'suspicious_body_language': 8.0  
#          }
...
#             total_score += min(weighted_score, 25.0)  
#             print(f"🚨 DEBUG: {action}: score={score:.1f}, weight={weight}, contribution={min(weighted_score, 25.0):.1f}")
...
#         if track_data['suspicious_score'] >= 30:
#             track_data['alert_level'] = 'CRITICAL'
#         elif track_data['suspicious_score'] >= 20:
#             track_data['alert_level'] = 'HIGH'
#         elif track_data['suspicious_score'] >= 10:  
...
#         """Draw pose keypoints and analysis results - simplified for headless"""
#         if keypoints is None:
#             return
...
#         cv2.putText(frame, f'ID: {track_id}', (x1, y1-80), 
#                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, alert_color, 2)
#         cv2.putText(frame, f'{track_data["alert_level"]} RISK', (x1, y1-55), 
#                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, alert_color, 2)
#         cv2.putText(frame, f'Score: {track_data["suspicious_score"]:.1f}', (x1, y1-30), 
...
# # HEADLESS VERSION - TIDAK ADA cv2.imshow() atau GUI functions
# def main():
#     print("Starting Improved Pose-Based Shoplifting Detection System v3.1 (Headless)...")
    
#     detector = PoseShopliftingDetector()
    
#     video_path = input("Enter video file path (or press Enter for 'input1.mp4'): ").strip()
#     if not video_path:
...
#             print(f"Progress: {progress:.1f}% ({detector.frame_count}/{total_frames})")
    
#     cap.release()
    
#     # Save results to JSON file
#     if alert_log:
#         log_path = f"shoplifting_alerts_{int(time.time())}.json"
...
#     results = main()
#     print(f"Returned {len(results)} alert records")
